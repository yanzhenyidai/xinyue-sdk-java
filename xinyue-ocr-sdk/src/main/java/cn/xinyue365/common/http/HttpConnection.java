...
public class HttpConnection {
    ...
    public Response getRequest(String url) throws XinyueSDKException, IOException {
    ...
    public Response getRequest(String url, Headers headers) throws XinyueSDKException, IOException {
        Request request = null;
        try {
    ...
    public Response postRequest(String url, String body) throws XinyueSDKException, IOException {
    ...
    public Response postRequest(String url, String body, Headers headers)
        throws XinyueSDKException, IOException {
